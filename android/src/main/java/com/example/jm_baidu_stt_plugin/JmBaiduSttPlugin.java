 ...
 * FlutterSpeechPlugin
 */
public class JmBaiduSttPlugin implements FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "jm_baidu_stt_plugin");
        channel.setMethodCallHandler(this);
        evenChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "jm_baidu_stt_plugin/event");
